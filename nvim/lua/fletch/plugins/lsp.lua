return {
	{
		...
		opts = {
			lsp = {
				hover = {
					border = require("fletch.misc.style").border,
				},
			},
			buffers = {
				set_filetype = true,
...

	{
		...
		config = function()
			...
			vim.lsp.handlers["textDocument/hover"] =
				vim.lsp.with(vim.lsp.handlers.hover, { border = require("fletch.misc.style").border })
			vim.lsp.handlers["textDocument/signatureHelp"] =
				vim.lsp.with(vim.lsp.handlers.signature_help, { border = require("fletch.misc.style").border })
